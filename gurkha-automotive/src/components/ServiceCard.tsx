...
export default function ServiceCard({ service }: { service: Service }) {
  return (
    <div className="card-panel group relative flex flex-col overflow-hidden p-6">
      <div className="absolute inset-x-0 top-0 h-1 bg-hazard-stripes opacity-0 transition-opacity group-hover:opacity-100" />
